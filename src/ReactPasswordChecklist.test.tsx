...
describe("ReactPasswordChecklist Test Suite", () => {
  ...
  describe("minLength", () => {
    it("Displays the default minLength message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["minLength"]} minLength={6} value="" />
      )
  ...
  describe("maxLength", () => {
    it("Displays the default maxLength message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["maxLength"]} maxLength={16} value="" />
      )
      expect(result.find("span").text()).toEqual(
  ...
  describe("specialChar", () => {
    ...
    it("Sets valid with _", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["specialChar"]} value="_" />
      )
      expect(result.find("li").hasClass("valid")).toBeTruthy()
    })
    it("Sets valid with ¿", () => {
  ...
  describe("lowercase", () => {
    it("Displays the default lowercase message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["lowercase"]} value="" />
      )
      expect(result.find("span").text()).toEqual(
  ...
  describe("noSpaces", () => {
    it("Displays the default no space message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["noSpaces"]} value="" />
      )
      expect(result.find("span").text()).toEqual("Password contains no spaces.")
    })
    it("Sets invalid", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["noSpaces"]} value="I have spaces" />
      )
      expect(result.find("li").hasClass("invalid")).toBeTruthy()
    })
    it("Sets valid", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["noSpaces"]} value="Idonthavespaces" />
      )
      expect(result.find("li").hasClass("valid")).toBeTruthy()
    })
  })
  describe("capitalAndLowerCase", () => {
    it("Displays the default capitalAndLowerCase message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["capitalAndLowerCase"]} value="" />
      )
      expect(result.find("span").text()).toEqual(
  ...
  describe("letter", () => {
    it("Displays the default letter message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["letter"]} value="" />
      )
      expect(result.find("span").text()).toEqual("Password has a letter.")
    })
    it("Sets invalid", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["letter"]} value="1234" />
      )
      expect(result.find("li").hasClass("invalid")).toBeTruthy()
    })
    it("Sets valid with lowercase", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["letter"]} value="i have a letter" />
      )
      expect(result.find("li").hasClass("valid")).toBeTruthy()
    })
  ...
  describe("notEmpty", () => {
    it("Displays the default notEmpty message", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["notEmpty"]} value="" />
      )
      expect(result.find("span").text()).toEqual(
    ...
    it("Sets valid", () => {
      const result = mount(
        <ReactPasswordChecklist rules={["notEmpty"]} value="0" valueAgain="1" />
      )
      expect(result.find("li").hasClass("valid")).toBeTruthy()
    })
  })
